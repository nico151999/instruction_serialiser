import { GreaterThanNode } from './instruction_serialiser/instruction_serialiser_pb';
...
declare module './instruction_serialiser/instruction_serialiser_pb' {
  interface GreaterThanNode extends CalculatableNode<boolean> {}
}

GreaterThanNode.prototype.calculate = function(parameters: InstructionParameters): boolean {
  return this.getLeftChild().calculate(parameters) >= this.getRightChild().calculate(parameters);
};

export { GreaterThanNode };
