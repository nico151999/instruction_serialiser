...
func (n *GreaterThanNode) calculate(parameters map[string]interface{}) (LogicalType, error) {
...
func (a *ArithmeticResultNodeWrapper) GreaterThan(node *ArithmeticResultNodeWrapper) *LogicalResultNodeWrapper {
